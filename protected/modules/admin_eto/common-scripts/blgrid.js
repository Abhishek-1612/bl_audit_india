...
function remove_file(file,type,act,mid,url){
    $.ajax({
        url: "/index.php?r=admin_marketplace/AuthorizedDealer/RemoveExcel&excel="+file,
        type: 'post',
        data: "",
        success: function(result) {
            $("#removedexcel").show();
            window.location.href = "index.php?r=admin_marketplace/AuthorizedDealer/Index&mid="+mid;
        }
    });
}
