                ...
                $('#submit_view').click(function(){
                    ...
                    if(diffDays>7)
                    {
                       ...
                       return false;
                        ...
                        result='';              
                        $.ajax({
                            url:"/index.php?r=admin_eto/BLDisplayGrid/downloadwithdb&mid=3777",
                            type: 'post',
                            data:a,
             ...
             <TR id="tr2">
              ...
              <td WIDTH="40%"> &nbsp;<input name="start_date" type="text" VALUE="<?php echo $start_date; ?>" SIZE="13" 
				...
				<TD bgcolor="#F0F9FF" style="color: #4A4A4A;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;font-size: 12px;width:40%; line-height:3px;" >
                                            <input type="radio" name="radiolocAction" value="G" checked> &nbsp;Global (1) &nbsp; &nbsp; &nbsp;                                          
                                            <input type="radio" name="radiolocAction" value="I" > &nbsp;India (2) &nbsp;<br/> 
                                            <input type="radio" name="radiolocAction" value="F" > &nbsp;Foreign (3) &nbsp; &nbsp; &nbsp;
                                          <input type="radio" name="radiolocAction" value="L" > &nbsp;Local (4) &nbsp;<br/>
                                          <input type="radio" name="radiolocAction" value="H" > &nbsp;Hyperlocal (9) &nbsp;&nbsp;&nbsp;		
				<span style="display:none" id="radiolocActionA"><input  type="radio" name="radiolocAction"   value="A" > &nbsp;All (1,2,3,4,9)</span>
                                </TD>
</tr><tr>
                            <td colspan="2"><input type="radio" name="rtype" value="G" checked> &nbsp;Location wise Grid&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                           
<input type="radio" name="rtype" value="NI" > &nbsp;Grid wise NI &nbsp; &nbsp; &nbsp;
