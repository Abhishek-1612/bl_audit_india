...
<head>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            ...
            if(document.getElementById('Associate_feedback').checked){
                a['Associate_feedback1'] = true;
            }


            result = '';
            $.ajax({
                url: "/index.php?r=admin_eto/auditEto/AuditForm&mid=3549",
                type: 'post',
                data: a,
                success: function(result) {
...
?>">
                ...
                <td style="padding:4px;">
                    <input type="submit" name="search"
                        style="font-weight:bold;margin: 0px 0px 0px 3px;float:left;width:80px;height:25px; text-align:center;"
            ...
            if($odioArr){
                ...
                if(isset($odioArr1['STATUS'])){
                   ...
                   $odio= '<tr><td colspan="3">&nbsp;&nbsp;<span style="color:red;">ODIO API Response :</span>'.$msg.''
                           . '&nbsp;&nbsp;<a href="/index.php?r=admin_eto/Odio/sendodio&mid=3813&offer_id='. $offerID .'" target="_blank">&nbsp;Send Request</A></td></tr>'; 
                }else{
...
<tr><td> Call Recording:';
        if ($recording_url <> '') {
            echo '&nbsp;&nbsp;<a href="' . $recording_url . '" TARGET="_blank" onclick="return checkURL("'.$recording_url.'")"><b style="color:#0000ff">&#187;&nbsp;Play Recording </b></A>';
        } else {
            echo '&nbsp;&nbsp;NA';
        }
