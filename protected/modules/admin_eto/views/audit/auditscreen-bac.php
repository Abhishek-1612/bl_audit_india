...
{
     var leadtypeVal = '';
    leadtypeVal = $('input[name="leadtype[]"]:checked').map(function() {
    return this.value;
    }).get().join();
    $("#leadtypeVal").val(leadtypeVal);
    return true;
}  
...
$checkarch='checked';
   ...
   <td >&nbsp;Search by Offer Id: </td>
    ...
    <td WIDTH="20%">&nbsp;Lead Type:</td>
              <td> &nbsp; <input type="checkbox" name="leadtype" value="R" <?php echo (isset($_REQUEST['leadtype']) && $_REQUEST['leadtype'] == 'R')?'CHECKED="CHECKED"':'' ?> />Retail&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="leadtype" value="NR" <?php echo (isset($_REQUEST['leadtype']) && $_REQUEST['leadtype'] == 'NR')?'CHECKED="CHECKED"':'' ?>/>Non Retail&nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="leadtype" value="AOV" <?php echo (isset($_REQUEST['leadtype']) && $_REQUEST['leadtype'] == 'AOV')?'CHECKED="CHECKED"':'' ?>/>High AOV 
                 </td>
    </tr>
    <tr id="trmain">
    <td >&nbsp;Team Leader: </td>
...
$deletedreasonArr=array(1=>'Duplicate Requirement',
   ...
   <?php       $vendorArr1=array();
    ...
    <input type="hidden" name="poolVal" id="poolVal" value=""><input type="hidden" name="leadtypeVal" id="leadtypeVal" value="">
    </td>
    </tr>
    <TR id="tr5">
    <td >&nbsp;Mail Sent To: </td>
    ...
    ?>
     ...
     <td><input type="radio" name="audit_for" value="normal_audit" checked />Normal Audit&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="audit_for" value="super_audit" <?php echo (isset($_REQUEST['audit_for']) && $_REQUEST['audit_for'] == 'super_audit')?'CHECKED="CHECKED"':'' ?>/>Super Audit 
          &nbsp;&nbsp;&nbsp;<input type="checkbox" value="shortcall" id="shortcall"  <?php echo (isset($_REQUEST['shortcall']) && $_REQUEST['shortcall'] == 'shortcall')?'CHECKED="CHECKED"':'' ?> name="shortcall" >&nbsp;Short Call
     </td>
    <?php } ?>
                 ...
                 <tr id="tr6">
                       <td WIDTH="20%">&nbsp;Lead Type:</td>
                     <td><input type="checkbox" id="retail" name="leadtype" value="R" <?php echo (isset($_REQUEST['leadtype']) && $_REQUEST['leadtype'] == 'R')?'CHECKED="CHECKED"':'' ?> />Retail&nbsp;&nbsp;
                         <input type="checkbox" id="rnretail" name="leadtype" value="NR" <?php echo (isset($_REQUEST['leadtype']) && $_REQUEST['leadtype'] == 'NR')?'CHECKED="CHECKED"':'' ?>/>Non Retail&nbsp;&nbsp;
  ...
  &nbsp;&nbsp;QA: &nbsp;
    <span name="team_qa" id="team_qa"></span>
                        ...
                        <input type="button" name="submit_view" id="submit_view" value="View Sample" onclick="check();checkleadtype();">
