...
<tr><td><form name="questionform" method="post">';
...
<input type="submit" name="save_close" id="save_close" onclick = "return validate()" 
style="font-weight:bold;margin: 0px 0px 0px 3px;float:center;width:120px;height:25px; text-align:center;" value="Save & Exit"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
<input id="tot_question" name="tot_question"  type="hidden" value="'.$q_cnt.'">
<input id="callrecordid" name="callrecordid" type="hidden" value="'.$callrecordid.'">
