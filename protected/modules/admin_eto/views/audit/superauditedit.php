    ...
    <div class="second_section">
      <div class="col-sm-3 col-md-3 col-lg-3 img_box">
        ...
        <?php  if($jobtype['jobtype']!= 13){ ?> 
          <span><a target="_blank" href="index.php?r=admin_eto/OfferDetail/editflaggedleads&offer=<?php echo $_REQUEST['offerID']; ?>&go=Go&mid=3945"> OFFER DETAIL: <?php echo $_REQUEST['offerID']; ?></a></span>
          <?php } else { ?> 
        ...
        <table style="border-collapse:collapse;" width="100%" cellspacing="0" cellpadding="3" >  
                     ...
                     <b> &nbsp;&nbsp; <a href="/index.php?r=admin_eto/OfrHist/etohistory&action=etohistory&act=ofrHist&offer=<?php echo $_REQUEST['offerID']; ?>&mid=3424" target="_blank">Offer</a></b>         
                            <?php
                         ...
                         echo '&nbsp;|| 
                     <b>&nbsp;<a href="/index.php?r=admin_eto/OfrHist/etohistory&action=etohistory&act=mapHist&offer=' .$_REQUEST['offerID']. '&mid=3424&status=' .$s. '&pl=no" target="_blank">Mapping</a></b>&nbsp;||
                     <b><a href="/index.php?r=admin_glusr/GlusrHistory/GlusrHistory&id=' . $FK_GLUSR_USR_ID . '&mid=46" target="_blank">GLUser </a></b>
                     &nbsp;||
                     <b><a href="/index.php?r=admin_eto/OfrHist/etohistory&act=locking&ad=' . $postDataOrig . '&dd=' . $deletedon . '&pd=' . $POST_DATE_ORIG . '&offer=' . $_REQUEST['offerID'] . '&postby=' . $PostBy . '&mid=3424"." target="_blank">Locking </a></b>
                     &nbsp;||
                     <b><a href="/index.php?r=admin_eto/OfrHist/etohistory&act=Isq_hist&offer=' .$_REQUEST['offerID'] . '&mid=3424" target="_blank">ISQ</a></b>';
             
             
                     echo '&nbsp;||<b><a href="/index.php?r=admin_eto/OfrHist/etohistory&act=autoHist&offer=' .$_REQUEST['offerID'] . '&mid=3424" target="_blank">Auto Approval</a></b>
                     &nbsp;';
                     ...
                     if ($postDataOrig <> '') {
                         ...
                         echo '&nbsp;<a href="/index.php?r=admin_eto/EnrichmentDetail/viewenrichment&offer=' .$_REQUEST['offerID']   . '&modid=' . $modid . '&tabletype=' . $tableType . '&mid=3424" target="_blank">Enrichment Details</a>&nbsp;<br>';
                          
                         echo '&#187;<a href="#" onclick="javascript:window.open(\'/index.php?r=admin_eto/Contact_details/Details&action=posted&offerID='.$_REQUEST['offerID'].'\',\'_blank\',\'scrollbars=yes,width=900, height=800\');" > Posted/Apprroval Date &nbsp;</a> ||';
                         echo '&nbsp;<a href="#" onclick="javascript:window.open(\'/index.php?r=admin_eto/Contact_details/Details&action=contact&offerID='.$_REQUEST['offerID'].'\',\'_blank\',\'scrollbars=yes,width=1400, height=800\');" > Buyer Contact Detail &nbsp;</a>';
                         ...
                         echo '&nbsp;||&nbsp;<a href="index.php?r=admin_eto/OfferDetail/multiplecallrecord&offer=' .$_REQUEST['offerID']  . '&glid=' . $glid . '&dt=' . $appDate . '&mid=3424" target="_blank">View All Recordings</A>';
             ?>  
                             </div>
                     </td>
                     <tr>
        ...
        <?php if($jobtype['jobtype']!= 13){ ?> <strong> BuyLEAD ISQ </strong> <?php } else {?> <strong> Reason </strong> <?php } ?>
          ...
          <span><a target="_blank" href="index.php?mid=3826&r=admin_eto/auditEto/Auditedit_v1/audit_id/<?php echo $task_i; ?>/ven_app/ALL/ven_audit/ALL/sd//ed//offer_id/<?php echo $_REQUEST['offerID']; ?>/r/0/"> 
           <?php } else if ($jobtype['jobtype']== 11 || $jobtype['jobtype']== 12){ ?>
            <span><a target="_blank" href="index.php?r=admin_eto/BulkAuditEto/AuditMis_Edit&offer_id=<?php echo $_REQUEST['offerID']; ?>&auditid=<?php echo $task_i; ?>&mid=3549"> 
            <?php } else if ($jobtype['jobtype']== 13){ ?>
              ...
              <span><a target="_blank" href="index.php?mid=3826&r=admin_eto/auditEto/Auditedit/stype/AUTO/audit_id/<?php echo $task_i; ?>/ven_app/ALL/ven_audit/ALL/sd//ed//offer_id/<?php echo $_REQUEST['offerID']; ?>/">
              <?php } else { ?>
              <span><a target="_blank" href="index.php?r=admin_eto/auditEto/Auditedit/stype/R/audit_id/<?php echo $task_i; ?>/ven_app/ALL/ven_audit/ALL/sd//ed//offer_id/<?php echo $_REQUEST['offerID']; ?>/r//">  
              <?php } ?>
...
margin-bottom: -10px;margin-top: 40px; ">Error Marked 
  ...
  <textarea id="old_remarks" name="old_remarks" readonly> <?php echo isset($db_details['task_audited_reason'])?$db_details['task_audited_reason']:''; ?></textarea>
  <textarea id="remarks" name="remarks" placeholder="enter new remarks.."></textarea>
                   </div>   
        </div>
      </div>
    </div>
    ...
    <div class="butons">
      <div class="first_buton">
        <a href="Javascript:void(0);" id="approve<?php echo $_REQUEST['offerID'] ; ?>"  onclick="set_status(<?php echo $_REQUEST['offerID'] ; ?>)" <?php  if ($db_details['task_audited_status']==1)
        {
            echo 'style=background-color:#17fc03;color:white;';
        } ?>> Correct Audit</a>
      </div>
      <div class="second_button">
        <a href="Javascript:void(0);" id="reject<?php echo $_REQUEST['offerID'] ; ?>" onclick="openRejectReason(<?php echo $_REQUEST['offerID'] ;?>)" <?php  if ($db_details['task_audited_status']==2)
        {
  ...
  <div class="last_box" id="last_box<?php echo $_REQUEST['offerID'] ;?>" >
    <div class="wrong_mcat" style="margin: 40px;">
            <?php
           
                  ?>
                  <div class="container2">    
                    <input type="radio" id="reason1" name="reason" value=" <?php echo $disp_arr[0]['task_disposition_id'] ;?> " <?php 
                    if($db_details['fk_task_disposition_id']== $disp_arr[0]['task_disposition_id'] ){
                ...
                <br>
                        ...
                        <div class="container2">
                        <input type="radio" id="reason2" name="reason" value="  <?php echo $disp_arr[1]['task_disposition_id'] ;?>"<?php 
                    if($db_details['fk_task_disposition_id']== $disp_arr[1]['task_disposition_id'] ){
                           echo 'checked=checked;';
                    }
                    ?>><span class="checkmark"> </span>
                ...
                <br>        
                <div class="container2">
                        <input type="radio" id="reason3" name="reason" value="  <?php echo $disp_arr[2]['task_disposition_id'] ;?>"<?php 
                    if($db_details['fk_task_disposition_id']== $disp_arr[2]['task_disposition_id'] ){
                           echo 'checked=checked;';
                    }
                    ?>><span class="checkmark"> </span>
              ...
              <br>
              <div class="container2">
                        <input type="radio" id="reason4" name="reason" value="  <?php echo $disp_arr[3]['task_disposition_id'] ;?>"<?php 
                    if($db_details['fk_task_disposition_id']== $disp_arr[3]['task_disposition_id'] ){
                           echo 'checked=checked;';
                    }
                    ?>><span class="checkmark"> </span>
  ...
  <input type="submit" name="save" id="save" value="Save Audit" style="border:none;padding: 5px 27px 5px 27px;">
  <input id="status_disposition" name="status_disposition"  type="hidden" >
  <input type="hidden" id="old_remark" name="old_remark" value="<?php echo($db_details['task_audited_reason']) ?>" >
