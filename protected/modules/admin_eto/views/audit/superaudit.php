...
margin-bottom: -10px;margin-top: 40px; ">Error Marked 
  ...
  <textarea id="remarks" name="remarks"> </textarea>
    ...
    <div class="butons">
      <div class="first_buton">
        <a href="Javascript:void(0);" id="approve<?php echo $_REQUEST['offerID'] ; ?>"  onclick="set_status(<?php echo $_REQUEST['offerID'] ; ?>)"> Correct Audit</a>
      </div>
      <div class="second_button">
        <a href="Javascript:void(0);" id="reject<?php echo $_REQUEST['offerID'] ; ?>" onclick="openRejectReason(<?php echo $_REQUEST['offerID'] ;?>)">Wrong Audit</a>
      </div>
  </div>
</div>
  ...
  <div class="last_box" id="last_box<?php echo $_REQUEST['offerID'] ;?>" style="display:none;">
