 <?php 
        ...
        $selvendor_name=isset($POST['vendor']) ? $POST['vendor']:'';
        ?>
<LINK HREF="/css/report.css" REL="STYLESHEET" TYPE="text/css">
	...
	<td width="100%" bgcolor="#dff8ff" class="intd" style="text-align:center;font-family: arial;font-size: 13px;color: #333399;" 
            colspan="3" align="center"><b>Quality Score</b>
	</td>
	</TR>
	<tr>
	...
	</td><td class="intd" width="40%" style="text-align:right;font-family: arial;font-size: 12px;background-color:#eeffff">&nbsp;&nbsp;Vendor: &nbsp;	
	...
	<?php 
       $vendorArr1=array();
		...
		<td align="center"  style="text-align:center;font-family: arial;font-size:12px;background-color:#eeffff">
