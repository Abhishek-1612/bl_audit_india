        ...
        if ($interval <= $noofdays) {
            ...
            if (count($dataArr) > 1) {
                ...
                <td colspan="7" align="center" style="padding:4px;"><b>Quality Score Summary</b></td></tr>
                   <tr style="background: #dff8ff; color: white;"><td style="padding:4px;font-weight:bold;">Total Audits</td>' . '<td align="center" style="padding:4px;font-weight:bold;">Wrong Deletion Disposition Selection Error</td>' . '<td align="center" style="padding:4px;font-weight:bold;">Can be Approved Error</td>'. '<td align="center" style="padding:4px;font-weight:bold;">Can be Flagged Error</td>'. '<td align="center" style="padding:4px;font-weight:bold;">Wrong Deletion error</td>' . '<td align="center" style="padding:4px;font-weight:bold;">Call Etiquettes</td>' . '<td align="center" style="padding:4px;font-weight:bold;">Error Score</td>' . '</tr>';
                echo '<tr><td align="center" style="padding:4px;">' . $totalaudit . '</td>' . '<td align="center" style="padding:4px;">' . $wrong_del_dis_selection_error . '</td>' . '<td align="center" style="padding:4px;">' . $can_be_approved . '</td>' . '<td align="center" style="padding:4px;">' . $can_be_flagged . '</td>' . '<td align="center" style="padding:4px;">' . $wrong_del_error . '</td>' . '<td align="center" style="padding:4px;">' . $call_ettiquettes . '</td>' . '<td align="center" style="padding:4px;">' . $error_score . '</td>' . '</tr>';
                echo '<tr><td align="center" style="padding:4px;">%</td>' . '<td align="center" style="padding:4px;">' . round((($wrong_del_dis_selection_error / $totalaudit) * 100), 2) . '</td>' . '<td align="center" style="padding:4px;">' . round((($can_be_approved / $totalaudit) * 100), 2) . '</td>' . '<td align="center" style="padding:4px;">' . round((($can_be_flagged / $totalaudit) * 100), 2) . '</td>' . '<td align="center" style="padding:4px;">' . round((($wrong_del_error / $totalaudit) * 100), 2) . '</td>' .'<td align="center" style="padding:4px;">' . round((($call_ettiquettes / $totalaudit) * 100), 2) . '</td>' . '<td align="center" style="padding:4px;">' . round((($error_score / $totalaudit) * 100), 2) . '</td>' . '</tr>';
                echo '</table>';
