...
function check_validate(){
               ...
               for(var j=0;j<ids.length;j++)
                ...
                $.ajax({ 	 	
                    type: "POST", 	
                    async: false,
                    url: "/index.php?r=admin_eto/BulkAuditEto/Audit&mid=3549", 	 	
                    data: a, 
                    success: function(result){ 	 
...
<input type="checkbox" id="process_level2" name="process_level" value="7" <?php echo (isset($_REQUEST['process_level2']) && $_REQUEST['process_level1'] == '7')?'CHECKED="CHECKED"':'' ?>/>&nbsp;7&nbsp;&nbsp;
             ...
             <TR id="tr2">
              <td WIDTH="20%">&nbsp;Date:</td>
              <td> &nbsp;<input name="start_date" type="text" VALUE="<?php echo $start_date; ?>" SIZE="13" onfocus="displayCalendar(document.sampleForm.start_date,'dd-mm-yyyy',this,'','','from_date1')" 
                                onclick="displayCalendar(document.sampleForm.start_date,'dd-mm-yyyy',this,'','','from_date1')" id="start_date" 
                                TYPE="text" readonly="readonly">&nbsp;&nbsp;</td>
              <td >&nbsp;Deleted By: </td>
              <td>&nbsp;<div style="float:left;margin:0 100 0 0"><select onchange="Newfilter(this.value);" name="vendor_approval" id="vendor_approval" style="border-radius: 3px 3px 3px 3px;font-size: 100%;width:320px;">
   ...
   <td >&nbsp;Search by Offer Id: </td>
    ...
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Max Records:&nbsp;&nbsp;<select name="maxrecords" id="maxrecords" style="border-radius: 3px 3px 3px 3px;font-size: 100%;">
    <?php
    ...
    <td WIDTH="20%">&nbsp;Sample type:
               &nbsp;<input type="radio" name="sample_type" value="0" checked />All&nbsp;&nbsp;
               &nbsp;<input type="radio" name="sample_type" value="1" />Manual&nbsp;&nbsp;
               &nbsp; <input type="radio" name="sample_type" value="2" />Auto
    </td>
