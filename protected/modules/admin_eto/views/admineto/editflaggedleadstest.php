...
?>
	...
	<script language="JavaScript" src="/protected/modules/admin_eto/js/eto-admin.js?v=44"></script>
    ...
    <?php 
        $server_name = !empty($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'gladmin.intermesh.net';
    ...
    <script language="javascript">
        ...
        {
            var newData = {'prevoffer':prevoffer,'status_check':status_check,'mid':mid,'prev_vendor_name':prev_vendor_name,};
            $.ajax({
                type: 'POST',
                dataType: 'HTML',
                data: newData,
                ...
                success : function(jsonResult){
                    ...
                    // document.getElementById("editform"+tid).style.display = "none";
                    // window.location.replace("index.php?r=admin_bl/Template/ShowTemplateList&mid=<?php //echo $mid;?>&msearchtype="+modID+"&psearchtype="+proID);
                },
                error: function(e) {
                    console.log(e);
                    alert('Some Error.');
    ...
    <body bgcolor="#FFFFFF">
        <form name="jumpForm" method="post" action="/index.php?r=admin_eto/OfferDetail/editflaggedleads&mid=3424" style="margin-top:0;margin-bottom:0;">       
            <table cellspacing="0" cellpadding="0" border="0" bgcolor="#0056cc" align="center" width="100%" style="color: rgb(255, 255, 255); font-family: arial; font-size: 12px;">
                <tbody>
                    <tr>
                        <?php
                        ...
                        <?php
                            if (!empty($rec) && !empty($offerID) && isset($rec['ETO_OFR_ID'])) {
                                ...
                                <td height="25px">
                                    ...
                                    <input type="text" name="offer" id="offer" style="width: 100px; float:left;margin:0px 0px 0px 3px;" maxlength="15" value="<?php echo $offerID; ?>" >
                                    <span style="float:left;">
                                        <input type="checkbox" name="arc" id="arc" value="1" <?php echo $arc_checked; ?> >&nbsp;<b>Archive Data</b>&nbsp;
                                    </span>
                                	<input type="hidden" name="status" value="<?php echo $status ?>">
                                	<input type="hidden" name="flag" value="<?php echo CHtml::encode($postParamArr['flag']); ?>">
                                	<input type="submit" name="jump" style="font-weight:bold;font-size: 11px; font-family: arial; padding: 0px; margin: 0px 0px 0px 3px;float:left;width:60px;height:21px; text-align:center;" value="Search" onclick="if(offer.value.match('^[0-9]+\$')){}else{alert('Enter only Numeric Value'); return false;}">
                                </td>
                                <td  align="right"><b>Status:</b>
                                    <span class="pp5" style="color: rgb(255, 222, 0); font-weight: bold;"></span><span title="<?php
                                        if ($status == 'P'){
        ...
        <div style="position:absolute; z-index:1000;  top:0px; margin-top:0px; left:0px; " align="center"class="win-close" id="div_info">
                        ...
                        <div class="bg_border">
                            <div style="background-color:#ffffff;">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td bgcolor="#e6e6e6">
                                            <div class="select_cat">Select Your Category</div>
                                        </td>
                                        <td align="right" style="padding-right:14px;" bgcolor="#e6e6e6"><img src="/gifs/close1.gif" width="20" height="14" onclick="win_open()">
                                        </td>
                                    </tr>
                                </table> <br>
                                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td  class="tabopen" width="180" id="s_tab" onclick="searchcat()">Search Categories</td>
                                        <td class="tabborder" width="10"><img height="1" src="/images/zero.gif" width="10"></td>
                                        <td width="170" class="tabclose"  id="b_tab" onclick="beowswcat()">Browse Categories</td>
                                    ...
                                    <tr>
                                        <td bgcolor="#f8fcff" valign="top">
                                            <div id="browse_cat" style="display:none;"><br>
                                                <form style="margin: 0px" name="test">
                                                    ...
                                                    align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td width="50%" style="font-family:arial; font-size:12px; padding-left:3px;"><b>1:</b><br>
                                                                    <span id="grp1"></span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td width="50%" style="font-family:arial; font-size:12px; padding-left:3px;">
                                                                    <div class="displayoff" id="display_mcat"><b>3:</b><br>
                                                                        <div style="border: 1px solid rgb(51, 102, 153); background-color:#ffffff; overflow: auto; height: 165px; padding-left: 1px; font-size: 13px;">
                                                                            <span id="div_mcat"></span>
                                                                        </div>
                                                                    </DIV>
                                                                </TD>
                                                                <td></td>
                                        	...
                                        	<div id="search_cat" ><br>
                                        	   <div class="blw" style="padding-left:6px; margin-top:6px; padding-bottom:4px;"><b style="font-size:13px;">
                                                ...
                                                <form name="ssss" onsubmit="return ListOnChange();">
                                                    <table cellspacing="0" cellpadding="0" width="525" border="0">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input class="myims" maxlength="60" size="33" name="txt_cat_mcat" id="txt_cat_mcat">
                                                                </td>
                                                                <td style="cursor:pointer;">
                                                                    <input type="button" name="button5" value="search" onclick="return ListOnChange();">
                                                                </td>
                                                                <td>
                                                                    <div class="blw1">For example, &quot;arm chair&quot; not &quot;furniture&quot;</div>
                                                                    <img height="1" src="/images/zero.gif" width="240">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div align="center" id='submit'>
                                                <img height="7" src="/images/zero.gif" width="1"><br>
                                                <input type="button" name="button2" value="Submit Category" onclick="win_open('cl_win')">
                                            </div>
                                            <div><br>
                                            </div>
                                        </td>
        ...
        <?php 
            ...
            if (!empty($rec) && !empty($offerID) && isset($rec['ETO_OFR_ID']))
            {
                ...
                <div align="center" id='secondary_data' onload="secondary_data(<?php echo $offerID;?>,<?php echo $status_check;?>,<?php echo $mid;?>,<?php echo $prev_vendor_name;?>);"> <img height="7" src="/images/zero.gif" width="1"><br>
                </div>
                <!-- <?php
                    ...
                    //     if ($offerdetHTML != '' || $BuyersDetailsHtml != '' || $transactiondetHTML != '')
                        {
                			...
                			<table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-family: arial;font-size: 12px;color: #000000;border: 0.2px solid grey;">
                				<th>
                					<?php //if (isset($arr_lvl_code['ETO_LEAP_VENDOR_NAME']) && ($arr_lvl_code['ETO_LEAP_VENDOR_NAME'] == 'NOIDA' || $arr_lvl_code['ETO_LEAP_VENDOR_NAME'] == 'DDN'))
                					{
                						?>
                						<td style="padding-left:20px; padding-top:2px;" width="20%">
                							<?php //echo "oooooooooo"; echo $offerdetHTML; ?>
                						</td>
                						<td>
                							<hr width="3%" size="230"></hr>
                						</td>
                						<td style="padding-left:3px; " width="20%">
                							<?php //echo "bbbbbbbbbbbb"; echo $BuyersDetailsHtml; ?>
                						</td>
                						<td>
                							<hr width="4%" size="230"></hr>
                						</td>
                						<td  width="53%" style="padding-top:2px;" >
                							<?php //echo "ttttttttttt"; echo $transactiondetHTML; ?>
                						</td>
                						<?php
                		            }
                		            //else
                		            {
                		            	?>
                						<td style="padding-left:20px; padding-top:2px;" width="50%">
                							<?php //echo "xxxxxxxxxxx";echo $offerdetHTML; ?>
                						</td>
                						<td>
                							<hr width="3%" size="230"></hr>
                						</td>
                						<td style="padding-left:3px; " width="50%">
                							<?php //echo "aaaaaaaaaaaaa"; echo $BuyersDetailsHtml; ?>
                						</td>
                						<?php
                					}
                					?>
                	...
                	<table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td bgcolor="#c6def1" class="pp5" height="28">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                            <div class="ffl">
                                                <select name="type" style="width:106px;font-size:15px;margin-left:3px;font-weight:bold">
                                                    <option value="B" selected >Buy Leads</option>
                                                </select>
                                            </div>
                                        </td>
                   	                    <?php
                                        ...
                                        <td>
                                            <div class="ffr modid">
                                                <span>Source: </span><span style="color:#c90000"><?php echo $Source; ?></span>    
                                                ...
                                                <span>&nbsp;&nbsp;RAG: </span><span style="color:<?php echo $color; ?>"><?php echo $rag; ?></span>
                                            </div>	
                                            </div>
                                        </td>
                                    </tr>
                        	...
                        	<td width="320" class="pp5" bgcolor="#c6def1">	
                        	   <div class="ffr modid">Country Quality: <span style="color:#c90000"><?php echo isset($rec['ETO_OFR_QUALITY']) ? $rec['ETO_OFR_QUALITY'] : '' ?> </span></div>
                            </td>
                    	</tr> 
                        <tr>
...
?>
            ...
            if ($status == "T" or $status == "D") {
                if (isset($rec['GL_EMP_NAME']) and isset($rec['GL_EMP_ID'])) {
                    echo $rec['GL_EMP_NAME'] . ' (' . $rec['GL_EMP_ID'] . ')';
                } else {
...
?>
                     ...
                     <?php echo '<tr><td width="92" class="pd5">Approved On:</td>';
            ...
            if (($status == 'A' || $status == 'E') && isset($rec['GL_EMP_NAME'])) {
                echo $rec['GL_EMP_NAME'] . ' (' . $rec['GL_EMP_ID'] . ')';
            }
            echo '</span></td></tr>';
?>
		...
		<td ><span style="color:#000090">Vkalp: No password<br>Cogent: indiamart | indiamart<br>Kochar: indiamart | In@d4321!<br>Kocharldh: indiamart | In@d4321!
		</span>
		</td>
		</tr>
                <tr>
...
<table style="border-collapse:collapse;" width="100%" cellspacing="0" cellpadding="3" bordercolor="#ebebeb" border="1">
		...
		&nbsp;||
		<b><a href="/index.php?r=admin_eto/OfrHist/etohistory&act=autoHist&offer=' . $offerID . '&mid=3424" target="_blank">Auto Approval</a></b>
		&nbsp;||
...
?>  
               ...
               <td width="50%"> 
                                <table border="0" align="center" cellpadding="2" cellspacing="0"  width="100%" class="alrt">
