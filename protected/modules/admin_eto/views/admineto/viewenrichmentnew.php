...
<?php 
          $errMsg =  isset($resultArr['errMsg'])?$resultArr['errMsg']:'';
          $quesArr = isset($resultArr['quesArr'])?$resultArr['quesArr']:'';               
          $flag = isset($resultArr['flag'])?$resultArr['flag']:'';  
    
          $html = '';$html_Usage = '';
          $counter=0;		  
		if(!empty($quesArr) && is_array($quesArr) && isset($quesArr))
		{
		...
		?>
         ...
         $imSpecMasterIdOrdervalue= $html = '';
          $counter=0;
          $ordervalueArray=array();
          if(!empty($quesArr)){
          foreach($quesArr as $quesKey => $quesValue){
