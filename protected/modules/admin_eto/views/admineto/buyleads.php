...
//echo "<pre>"."Result rec===";print_r($recResult);
         	...
         	foreach($recResult as $recK => $rec) {  	
              ...
              echo '<TR style="background: #dff8ff;"><TD algn="center" class="td_head" width="2%"></td> 
                  <td class="td_head" width="75%"><TABLE WIDTH="100%" BORDER="0" bordercolor ="#3f80d8" CELLPADDING="0" CELLSPACING="0"><tr style="color: #333399; background: #dff8ff;">
                        <TD class="td_head" width="15%"><b>GLID:</b> <A HREF="javascript:popup(\'/index.php?r=admin_eto/AdminEto/admincontact&mem='.$glid.'&mid=3424\');">'.$glid.'</A> ['.$userStatusDesc[@$rec['GLUSR_USR_APPROV']].']</TD>
                        ...
                        if(isset($rec['OFR_STATUS']) && ($rec['OFR_STATUS']=='D' || $rec['OFR_STATUS']=='E')){
                                ...
                                if ($lvl_code=='E' || $lvl_code=='V') {
                                    ...
                                    echo '<tr><td class="td_head" ><A target="_blank" HREF="/index.php?r=admin_eto/OfrHist/etohistory&act=locking'.$date_values.'&offer='.$offerID.'&mid=3424">Locking History<a></td></tr>';
                                     ...
                                     echo '<tr><td class="td_head" ><a href="/index.php?r=admin_eto/OfrHist/etohistory&act=Isq_hist&offer=' . $offerID . '&mid=3424" target="_blank">ISQ</a></td></tr>';
                                     echo '<tr><td class="td_head" ><a href="/index.php?r=admin_eto/OfrHist/etohistory&action=etohistory&act=mapHist&offer=' . $offerID . '&status='.@$rec['OFR_STATUS'].'&mid=3424" target="_blank">Mapping</a></td></tr>';
                                }
