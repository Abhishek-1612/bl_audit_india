...
<LINK HREF="/css/report.css" REL="STYLESHEET" TYPE="text/css">
		...
		<tr>
			 ...
			 <a href="/index.php?r=admin_eto/AdminEto/leapdashboard&action=exportFeedback&start_date=<?php echo $start_date; ?>&
			 end_date=<?php echo $end_date; ?>&vendor=<?php echo $vendor; ?>&source=<?php echo $source; ?>
			 &employeeID=<?php echo $employeeID; ?>&start_time=<?php echo $start_time; ?>&end_time=<?php echo $end_time; ?>&tlid=<?php echo $tlid; ?>&in_flag=<?php echo $in_flag; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>&mid=3443" target="_blank">Export To Excel</a>
			<?php 
