...
<tr><TD class="td_head" width="15%"><b>Posted on :</b></td><td><?php echo $rec["ETO_TDR_PUBLISH_DATE"];?></td><td class="td_head" width="15%">Agent name (ID)</td><td ><?php echo @$rec["AGENT_NAME"].'('.@$rec["AGENT_ID"];?>)</td></tr>  
<tr><TD class="td_head" width="15%"><b>Tender Details:</td><td><?php echo $rec["ETO_TDR_DESC"];?></td><td class="td_head" width="15%">Company website</td><td><?php echo @$rec["COMPANY_WEBSITE"];?></td></tr>  
<tr><TD class="td_head" width="15%"><b>Tender Value</td><td><?php echo $rec["ETO_TDR_TENDERVALUE"];?></td><td class="td_head" width="15%">Authority name</td><td><?php echo @$rec["AUTHORITY_NAME"];?></td></tr>  
<tr><TD class="td_head" width="15%"><b>EMD</td><td><?php echo $rec["ETO_TDR_EARNEST"];?></td><td class="td_head" width="15%">Approval date</td><td><?php echo @$rec["APPROVAL_DATE"];?></td></tr>  
...
echo '<tr><TD class="td_head" width="15%"><b>Image</b></td><td><a href="'.$rec["ETO_TDR_IMGPATH"].'">View</a></td></tr>';  
 }
 if(isset($rec["ETO_TDR_DOCPATH"])){
echo '<tr><TD class="td_head" width="15%"><b>Document</b></td><td><a href="'.$rec["ETO_TDR_DOCPATH"].'">View</a></td></tr>';  
 }
?> 
</TABLE>
 <?php 
