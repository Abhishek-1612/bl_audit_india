...
<table style="border-collapse: collapse;" border="0" bordercolor="#bedaff" cellpadding="4" cellspacing="0" width="100%">
    ...
    ?>
        ...
        <tr>
            ...
            <td style="padding:4px;">
                <input onclick = "validate_radio(this.name)" type="radio" name="<?= 'delopt_' . $offerID;?>" value="227"  id="<?= 'delopt_' . $offerID;?> " <?= $checkradio1;?> >
            ...
            <td width="40%" rowspan=2>
                <table border=0 cellpadding="0" cellspacing="0"  width="100%">
                    <tr>
                        <td>
                            <input onclick = "validate_opt(this.name)"  type="checkbox" <?= $check1;?> width="100px" value="228" name="<?= 'chk_' . $offerID;?>" id="<?= 'chk_228_'. $offerID; ?>" >
                            <font color="red">Second Call Attempt Required but Flagged</font>
                        </td>
                        <td>
                            <input onclick = "validate_opt(this.name)"  type="checkbox" <?= $check3;?> width="100px" value="230" name="<?= 'chk_' . $offerID;?>" id="<?= 'chk_230_'. $offerID; ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input onclick = "validate_opt(this.name)"  type="checkbox" <?= $check4;?> width="100px" value="231" name="<?= 'chk_' . $offerID;?>" id="<?= 'chk_231_'. $offerID; ?>">
