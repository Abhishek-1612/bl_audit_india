...
<tr>
    <td width="50%" align="center" bgcolor="#aad2f8"><a href="index.php?r=admin_bl/Iilmasterdatafill/add/" style="font-size:16px;font-weight:bold; color:#333;text-decoration:none;width:100%;">ADD</a></td>
...
<?php
	  ...
	  echo '<div><center><font color="red" size=3>'.$errorMsg.'</font></center></div>';
          ...
          echo '<br><div align="center"><form name="iilMaster" method="post" action="">
	  <select id="iilMasterSelect" name="iilMasterSelect">
