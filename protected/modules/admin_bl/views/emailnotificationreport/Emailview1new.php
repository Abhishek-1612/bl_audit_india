...
$cntcat=0;
   while ($cntcat<count($category_list))
	...
	$disp = "none";
	if($category_search == 'Auto mailer for verification')
	{
	$disp = "block";
	echo '<option value="Auto mailer for verification" selected>Auto mailer for verification</option>';
	}
	else
	{
	echo '<option value="Auto mailer for verification">Auto mailer for verification</option>';
	}
	
	
	$disp = "none";
	if($category_search == 'New Registration Mail-FCP')
	{
	$disp = "block";
	echo '<option value="New Registration Mail-FCP" selected>New Registration Mail-FCP</option>';
	}
	else
	{
	echo '<option value="New Registration Mail-FCP">New Registration Mail-FCP</option>';
	}
	
	$disp = "none";
	if($category_search == 'EMAIL VERIFY TELE SALES')
	{
	$disp = "block";
	echo '<option value="EMAIL VERIFY TELE SALES" selected>EMAIL VERIFY TELE SALES</option>';
	}
	else
	{
	echo '<option value="EMAIL VERIFY TELE SALES">EMAIL VERIFY TELE SALES</option>';
	}
	...
	<select style="width:110" name="event_search" ><option value="ALL">All Events</option>';
